...
<main class="container" style="min-height: 65vh;">
    ...
    <div class="row">
        ...
        ?>
                    ...
                    <div class="card hero-section border-0 shadow-lg position-relative">
                        <div class="row g-0">

                            <!-- COLUMNA DE LA IMAGEN (Esta parte la dejamos tal cual estaba) -->
                            <div class="col-lg-7">
                            ...
                            <!-- COLUMNA DE TEXTO (Le agregamos el fondo rojo y los textos blancos) -->
                            <div class="col-lg-5 p-4 p-md-5 d-flex flex-column justify-content-center text-white" style="background-color: #c93b28;">
                    ...
                    <i class="fa-solid fa-shield-check me-1"></i> <?php echo $reg->calificacion; ?>
                                ...
                                <a href="articulo.php?id=<?php echo $reg->idnoticia; ?>" class="text-decoration-none text-white stretched-link">
                                    <h1 class="main-title"><?php echo $reg->titulo; ?></h1>
                                </a>

                                <p class="lead text-white d-none d-sm-block" style="opacity: 0.9;"><?php echo $reg->resumen; ?></p>

                                <div class="d-flex align-items-center mt-3 mt-md-4">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0 fw-bold small">Por <?php echo $reg->autor; ?></h6>
                                        <small style="color: rgba(255, 255, 255, 0.7);"><?php echo date("d M, Y", strtotime($reg->fecha_publicacion)); ?></small>
                                    </div>
                                </div>
                            </div>
